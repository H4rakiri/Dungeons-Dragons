...
url: https://dnd.su/spells/508-invulnerability/
cssclass: spell-card
---

<div class="spell-container">
    <div class="spell-header">
        <h1 class="spell-name">Неуязвимость</h1>
    ...
    <div class="spell-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-value">В, С, М (небольшой кусочек адамантина стоящий не менее 500 зм, расходуемый заклинанием)</div>
        </div>
        <div class="stat-card">
