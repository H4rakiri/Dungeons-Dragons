...
url: https://dnd.su/spells/3067-summon-undead/
cssclass: spell-card
---

<div class="spell-container">
    <div class="spell-header">
        <h1 class="spell-name">Призыв духа нежити</h1>
    ...
    <div class="spell-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-value">В, С, М (позолоченный череп стоимостью не менее 300 зм)</div>
        </div>
        <div class="stat-card">
