...
url: https://dnd.su/spells/3069-summon-shadowspawn/
cssclass: spell-card
---

<div class="spell-container">
    <div class="spell-header">
        <h1 class="spell-name">Призыв духа тени</h1>
    ...
    <div class="spell-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-value">В, С, М (слезы внутри драгоценного камня стоимостью не менее 300 зм)</div>
        </div>
        <div class="stat-card">
