...
url: https://dnd.su/spells/3065-summon-construct/
cssclass: spell-card
---

<div class="spell-container">
    <div class="spell-header">
        <h1 class="spell-name">Призыв духа конструкта</h1>
    ...
    <div class="spell-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-value">В, С, М (затейливая шкатулка с замком, сделанная из камня и металла, стоимостью не менее 400 зм)</div>
        </div>
        <div class="stat-card">
